...
export const FormInformation = () => {
    return (
        <div >
            <h2 className="w-full text-3xl text-white my-4 float-right rounded-lg bg-gradient-to-r from-green-500 via-blue-800 to-blue-300 border-r-4">Información</h2>
            <form className="flex flex-col gap-4 p-4">
                <div className="flex flex-col gap flex-0">
                    ...
                    <div className="flex flex-col gap-0">
                        <div>
                            <label htmlFor="docNumber" className="block mb-2 text-sm font-medium text-gray-900">Fecha de
                                Nacimiento*</label>
                            <input type="text" id="docNumber"
                                   className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                   placeholder="Ingrese el número de documento"/>
                    ...
                    <div className="flex flex-col gap-0">
                        <div>
                            <label htmlFor="docNumber" className="block mb-2 text-sm font-medium text-gray-900">Pais de
                                Nacimiento*</label>
                            <input type="text" id="docNumber"
                                   className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                   placeholder="Ingrese el número de documento"/>

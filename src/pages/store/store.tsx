        ...
        <div>
            ...
            <form className="flex flex-col gap-4 p-4">
                <div className="flex gap-4">
                    <div>
                        <label htmlFor="docType" className="block mb-2 text-sm font-medium text-gray-900">Tipo de
                            Documento*</label>
                        <select id="docType"
                    ...
                    <div className="flex gap-4 items-end">
                        <div>
                            <label htmlFor="docNumber" className="block mb-2 text-sm font-medium text-gray-900">Número
                                de Documento*</label>

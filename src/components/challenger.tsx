...
//
// Eres libre de agregar clases y estilos, pero asegúrate de dejar los ID de los componentes y las clases proporcionadas como están. Envíe su código una vez que esté completo y nuestro sistema validará su resultado.
